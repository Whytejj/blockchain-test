# -*- coding: utf-8 -*-
"""
Created on Wed Jan  5 23:20:16 2022
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'mike', amount = 1)
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        response = {'message': 'All good, this is the largest chain',
